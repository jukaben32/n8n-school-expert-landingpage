...
export default async function PlanificarClasePage({
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        <Link href={`/dashboard/planificacion?fecha=${date}`} className="text-sm hover:underline" style={{ color: 'var(--dash-accent)' }}>
          ← Planificación de clases
        </Link>
        <h1 className="text-2xl font-bold font-barlow text-slate-900 tracking-tight mt-1 capitalize">
