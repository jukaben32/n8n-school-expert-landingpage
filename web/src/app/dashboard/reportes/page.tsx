...
export default async function ReportesPage() {
  ...
  const [{ data: attendanceRaw, error: attendanceRawError }, { data: invoicesRaw, error: invoicesRawError }, { data: studentsRaw, error: studentsRawError }] = await Promise.all([
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      <QueryErrorBanner errors={[{ label: 'la asistencia', error: attendanceRawError }, { label: 'los cobros', error: invoicesRawError }, { label: 'los estudiantes', error: studentsRawError }]} />
      <div>
