...
export const metadata: Metadata = {
  title: 'MentorIA — El colegio, ordenado. La familia, tranquila.',
  description:
...
const faqs = [
  {
    ...
    a: 'No. MentorIA es una aplicación web: se entra desde el navegador del celular o la computadora, con su correo y contraseña, sin descargar nada.',
  },
  {
      ...
      <header className="sticky top-0 z-30 border-b border-white/10 bg-ink/90 backdrop-blur">
        <nav className="max-w-6xl mx-auto px-5 h-16 flex items-center justify-between">
          <a href="#inicio" className="flex items-center gap-2.5">
            ...
            <span className="font-display font-semibold text-lg text-white tracking-tight">MentorIA</span>
          </a>
      ...
      <footer className="bg-ink border-t border-white/10">
        <div className="max-w-6xl mx-auto px-5 py-10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-display text-sm text-white/70">MentorIA</span>
          </div>
