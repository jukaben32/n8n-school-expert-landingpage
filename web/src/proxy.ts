...
export async function proxy(request: NextRequest) {
  ...
  const publicPrefixRoutes = ['/login', '/registro', '/recuperar-contrasena', '/actualizar-contrasena', '/colegio', '/terminos', '/api/auth/update-password-from-link', '/api/pagos/azul', '/api/cron']
