...
console.log(`> Nota: márcalos **"No, no es contenido para niños"** en el formulario de`)
console.log(`> YouTube solo si el canal así lo requiere para tu configuración; el`)
console.log(`> contenido es educativo escolar y esa casilla afecta comentarios y`)
console.log(`> monetización (ver la sección de YouTube en AGENTS.md).\n`)
console.log(`---\n`)
